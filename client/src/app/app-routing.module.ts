...
export const routingComponents =[ HomeComponent,LoginComponent,SignupComponent,
                                  ServicesComponent,CustomerdashboardComponent, AboutusComponent, CustomerprofileComponent,
                                  CustomerHomeComponent, OrderComponent, ScheduledOrderComponent, MyordersComponent, EditprofileComponent,
